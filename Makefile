...
SOURCES       = src/controllers/TimerManager.cpp \
		...
		moc_VirtualLED.cpp
OBJECTS       = TimerManager.o \
		VirtualLEDController.o \
		UserInterface.o \
		ColorProfile.o \
		DateTime.o \
		ScheduledTask.o \
...
DIST          = /opt/homebrew/share/qt/mkspecs/features/spec_pre.prf \
		...
		Pilluminate.pro include/controllers/TimerManager.h \
		...
		include/utils/ConfigurationManager.h src/controllers/TimerManager.cpp \
		src/controllers/VirtualLEDController.cpp \
		src/interfaces/UserInterface.cpp \
		src/models/ColorProfile.cpp \
		src/models/DateTime.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/controllers/TimerManager.h include/controllers/VirtualLEDController.h include/interfaces/UserInterface.h include/models/ColorProfile.h include/models/DateTime.h include/models/ScheduledTask.h include/models/VirtualLED.h include/utils/ConfigurationManager.h $(DISTDIR)/
	$(COPY_FILE) --parents src/controllers/TimerManager.cpp src/controllers/VirtualLEDController.cpp src/interfaces/UserInterface.cpp src/models/ColorProfile.cpp src/models/DateTime.cpp src/models/ScheduledTask.cpp src/models/VirtualLED.cpp src/utils/ConfigurationManager.cpp src/main.cpp $(DISTDIR)/
...
TimerManager.o: src/controllers/TimerManager.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o TimerManager.o src/controllers/TimerManager.cpp

VirtualLEDController.o: src/controllers/VirtualLEDController.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o VirtualLEDController.o src/controllers/VirtualLEDController.cpp
...
ColorProfile.o: src/models/ColorProfile.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ColorProfile.o src/models/ColorProfile.cpp

DateTime.o: src/models/DateTime.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o DateTime.o src/models/DateTime.cpp

ScheduledTask.o: src/models/ScheduledTask.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ScheduledTask.o src/models/ScheduledTask.cpp
...
ConfigurationManager.o: src/utils/ConfigurationManager.cpp 
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o ConfigurationManager.o src/utils/ConfigurationManager.cpp
